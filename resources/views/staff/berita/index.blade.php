        ...
        <div class="col-md-12 mb-6">
            <div class="card text-left">
                <div class="card-body">
                    ...
                    <a class="btn btn-twitter btn-icon m-1" href="{{ route('staff.berita.create') }}">
                        ...
                        <table id="zero_configuration_table" class="table" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $row->judul }}</td>
                                    <td>{{ $row->desc}}</td>
                                    <td>{{ date('j F Y,his',strtotime($row->tanggal_upload))}}</td>
                                    <td>
                                    ...
                                    <td>
                                        <center>
                                            ...
                                            <center>
                                             ...
                                             <a type="button" onclick="deleteberita({{ $row->id_berita }})" class="text-danger mr-2">
                                               <i class="nav-icon i-Close-Window font-weight-bold"></i>
                                           </a>
                                       </center>
                                 </center>

                                 <form  id="delete-form-{{$row->id_berita}}" style="display:none;" action="{{ route('staff.berita.destroy',$row->id_berita) }}"  method="POST">
                                   {{ @csrf_field() }}
                                   {{@method_field('DELETE')}}
                               </form>
                           </td>
